...
var Brush = /** @class */ (function () {
    ...
    Brush.lightenBy = function (color, fraction) {
        ...
        if (!c)
            return color;
        return Color.toString(Math.round(c.r + (255 - c.r) * fraction), Math.round(c.g + (255 - c.g) * fraction), Math.round(c.b + (255 - c.b) * fraction), c.a);
    };
